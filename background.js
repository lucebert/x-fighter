...
var background = new $.gameQuery.Animation({imageURL : "bg/sky.jpg"}); //image fond
var cloud1 =  new $.gameQuery.Animation({imageURL : "bg/nuage1.png"}); //image nuage
var hurt =  new $.gameQuery.Animation({imageURL : "bg/hurt.jpg"});
