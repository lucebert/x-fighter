...
var explosion2 = new $.gameQuery.Animation({
	imageURL: "assets/img/fighter/Explosion2.png",
...
var missileEnnemy = new $.gameQuery.Animation({
	imageURL: "assets/img/fighter/missileEnnemy2.png",
...
var badguy = new $.gameQuery.Animation({ imageURL: "assets/img/fighter/ennemy1.png" });
var badguyH = new $.gameQuery.Animation({ imageURL: "assets/img/fighter/ennemy1H.png" });
			...
			if ($("#badguy" + i).y() > -168) {
				for (j = 1; j < 7; j++) {
					$("#missileG" + j).collision("#badguy,#badguy" + i).each(function () {
						ml[j] = $("#missileD" + j).y();  //memoire de la position des missiles
